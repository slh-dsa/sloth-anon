...
###	cw305_main.xdc  2024-01-01  ((Anon))
...
set_property -dict { PACKAGE_PIN T13    IOSTANDARD LVCMOS33 } [get_ports { extclk_out }];
set_property -dict { PACKAGE_PIN A12	IOSTANDARD LVCMOS33 } [get_ports { uart_rxd }];
set_property -dict { PACKAGE_PIN A14	IOSTANDARD LVCMOS33 } [get_ports { uart_txd }];
