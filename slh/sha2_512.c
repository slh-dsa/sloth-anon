...
static void sha512_init_h0(sha512_t *sha, const uint8_t *h0)
{
	memcpy(sha->s, h0, 64);
	sha->i = 0;
	sha->len = 0;
...
void sha512_init(sha512_t *sha)
{
	...
	sha512_init_h0(sha, sha2_512_h0);
}
...
void sha384_init(sha512_t *sha)
{
	...
	sha512_init_h0(sha, sha2_384_h0);
}
#endif
